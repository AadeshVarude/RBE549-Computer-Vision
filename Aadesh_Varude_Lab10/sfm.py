...
# Reading the images
img1 = cv.imread('Aadesh_Varude_Lab10/image1.jpg', cv.IMREAD_GRAYSCALE)  #queryimage # left image
img2 = cv.imread('Aadesh_Varude_Lab10/image2.jpg', cv.IMREAD_GRAYSCALE) #trainimage # right image

# Defining feature extractor
sift = cv.SIFT_create()
# surf =cv.xfeatures2d.SURF_create()

# find the keypoints and descriptors with SIFT and SURF
